...
fn memset(dest: ?[*]volatile u8, c: u8, len: usize) ?[*]volatile u8 {
...
fn __aeabi_memcpy(dest: [*]u8, src: [*]u8, n: usize) callconv(.AAPCS) void {
    _ = memcpy(dest, src, n);
}
fn __aeabi_memcpy4(dest: [*]u8, src: [*]u8, n: usize) callconv(.AAPCS) void {
    _ = memcpy(dest, src, n);
}
fn __aeabi_memcpy8(dest: [*]u8, src: [*]u8, n: usize) callconv(.AAPCS) void {
    _ = memcpy(dest, src, n);
}

fn __aeabi_memset(dest: [*c]volatile u8, len: usize, c: c_int) [*c]volatile u8 {
    if (len == 0) {
        return dest;
    }
...
fn __aeabi_memset4(dest: [*c]volatile u8, len: usize, c: c_int) [*c]volatile u8 {
    if (len == 0) {
        return dest;
    }
    for (dest[0..len]) |*b| b.* = @as(u8, @intCast(c));
...
fn __aeabi_memset8(dest: [*c]volatile u8, len: usize, c: c_int) [*c]volatile u8 {
    if (len == 0) {
        return dest;
    }
    for (dest[0..len]) |*b| b.* = @as(u8, @intCast(c));
...
fn __aeabi_memclr(dest: [*c]volatile u8, len: usize) [*c]volatile u8 {
    return __aeabi_memset(dest, len, 0);
}
fn __aeabi_memclr4(str: [*]volatile u8, n: usize) callconv(.AAPCS) [*c]volatile u8 {
    _ = @call(.always_inline, __aeabi_memset, .{ str, n, 0 });
    return str;
}

fn __aeabi_memmove(dest: [*]u8, src: [*]u8, n: usize) callconv(.AAPCS) void {
    _ = memmove(dest, src, n);
}
fn __aeabi_memmove4(dest: [*]u8, src: [*]u8, n: usize) callconv(.AAPCS) void {
    _ = memmove(dest, src, n);
}
fn __aeabi_memmove8(dest: [*]u8, src: [*]u8, n: usize) callconv(.AAPCS) void {
    _ = memmove(dest, src, n);
}
